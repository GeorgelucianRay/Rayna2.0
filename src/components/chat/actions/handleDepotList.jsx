...
/* ─────────────────────────────
   Ctx în sessionStorage (pas-cu-pas)
   ───────────────────────────── */
...
export default async function handleDepotList({ userText, setMessages, setAwaiting }) {
  ...
  // Debug vizibil în chat (poți scoate dacă te deranjează)
  setMessages(m => [
    ...m,
    {
      from: "bot",
...
• Excel: ${wantExcel ? "da" : "nu"}`
  ...
  // dacă lipsește size dar avem alt filtru, cerem 20/40/da igual
