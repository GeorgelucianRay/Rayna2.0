...
const CFG = {
  ground: {
    ...
    abcOffsetX:  0,    // mută ABC stânga/dreapta
    defOffsetX:  0,    // mută DEF stânga/dreapta
    abcToDefGap: 80,   // distanța pe Z între ABC și DEF (mai negativ => DEF mai jos, culoar mai lat)
  },
