import { makeRoundabout }  from './prefabs/Roundabout.js'; // +++ NOU

export const PROP_TYPES = [
  { key: 'road.segment',   label: 'Șosea 12×40 m' },
  { key: 'road.roundabout',label: 'Sens giratoriu Ø40 / bandă 12' }, // +++ NOU
...
export function createMeshFor(type, opts = {}) {
  switch (type) {
    ...
    case 'road.roundabout': // +++ NOU
      return makeRoundabout({
        outerR: 20,   // diametru 40 m
        ringW: 12,    // lățime carosabil = lățimea drumului tău
        h: 0.02,
